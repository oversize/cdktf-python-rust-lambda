...
// Main will only be run on the boot/creation of the lambda (coldstarts)
// Subsequent request will directly  handled by the handler function
#[tokio::main]
async fn main() -> Result<(), Error> {
    println!("Lambda starting up lambda ... ");
